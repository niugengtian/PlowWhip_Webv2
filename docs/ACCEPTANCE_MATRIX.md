...
| 11–13 | Settings revision, OS capability and explicit scheduler authorization tests |
...
The actual OS scheduler installation remains explicit human authorization evidence because it writes outside the project directory. No publish or external Secret transfer is performed by acceptance tests.
