...
| H-20260724-19 | 2026-07-24 | 主人现场验证 | `NeedsDecision` 必须先反馈准确原因、观察事实、证据来源和各选择的影响；没有原因时不得要求主人授权 | 已实现，待 8750 现场复核 | Task API 增加当前 Spec revision 的 `decision_context`；UI 以原因/本地与远端 SHA/Evidence/选项影响在前、授权在后；缺上下文时只开放只读刷新；全套 50 项回归通过 |
